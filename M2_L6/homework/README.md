...
lesson-06/
  slides.pptx
  demo/               the program shown in class
...
The knob covers -40 to +140 degrees Celsius: the range a car engine coolant
circuit lives in. The bands are the ones a dashboard would show.

| Temperature, Celsius | Band | Colour | Bits |
|---|---|---|---|
| below 0 | frozen | blue | 100 |
| 0 to 59 | cold | cyan | 110 |
| 60 to 89 | warming up | green | 010 |
| 90 to 109 | working temperature | yellow | 011 |
| 110 and above | overheating | red | 001 |
...
3. Turn the knob. The temperature prints in Celsius, but the LED stays dark
   until you write the missing function.
...
89 or 90 degrees, and leave it there. The colour will jump back and forth,
