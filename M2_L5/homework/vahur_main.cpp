...
HOMEWORK L5
//
static const uint8_t F_OFFSET = 32;
static const uint8_t F_NUMERATOR = 5;
static const uint8_t F_DENOMINATOR = 9;
...
static int16_t fahrenheitToCelsius(int16_t fahrenheit) {
    ...
    return (int16_t) ((fahrenheit - F_OFFSET) * F_NUMERATOR / F_DENOMINATOR);
}
